...
const projects = [
  ...
  },
  {
    ...
    description: "Real-time messaging application with AI-powered chat features, voice messages, and file sharing capabilities.",
    image: "/api/placeholder/400/250",
  ...
  },
  {
    ...
    description: "Modern portfolio website with smooth animations, dark theme, and responsive design showcasing projects and skills.",
    image: "/api/placeholder/400/250",
  ...
  },
  {
    ...
    description: "Analytics platform for social media metrics with data visualization, reporting, and performance insights.",
    image: "/api/placeholder/400/250",
